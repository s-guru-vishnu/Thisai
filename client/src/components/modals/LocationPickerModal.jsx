...
const LocationPickerModal = ({ isOpen, onClose, onConfirm, initialLocation }) => {
    ...
    const [markerPosition, setMarkerPosition] = useState(initialLocation || { lat: 11.0168, lng: 76.9558 });
            ...
            <div style={{
                ...
                <div style={{
                    ...
                    <div>
                        ...
                        <p style={{ margin: '4px 0 0', fontSize: '0.8rem', color: '#888' }}>Tap on the map or drag the pin</p>
                    </div>
                ...
                <div style={{ flex: 1, minHeight: '350px', position: 'relative' }}>
                    {isLoaded ? (
                        ...
                        <div style={{ width: '100%', height: '350px', background: '#111', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#555' }}>
                            Loading map...
                        </div>
                    )}
                </div>
